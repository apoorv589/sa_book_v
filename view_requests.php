...
?>
			<tr>
				<td><a href="<?php echo site_url("sah_booking/booking_request/details/".$data_array_pending[$sno][1]."/".$auth);?>"><?php echo $data_array_pending[$sno][1];?></a></td>
...
?>
			<tr>
				<td><a href="<?php echo site_url("sah_booking/booking_request/details/".$data_array_cancel[$sno][1]."/".$auth);?>"><?php echo $data_array_cancel[$sno][1];?></a></td>
...
?>
					<thead>
						<tr>
							...
							<th>Applied By</th>
							<th>No. of Guests</th>
							<? if($auth == 'est_ar') echo '<th>Forced Cancellation</th>'; ?>
						</tr>
					</thead>
<?php
					$sno=1;
							...
							<? if($auth == 'est_ar')
								{
									...
									else if($data_array_approved[$sno]['est_ar_status'] == 'Cancelled') echo '<center>Cancelled</center>';
									else {
										echo '<center>';
										$form = $ui->form()
												   ->multipart()
												   ->action('sah_booking/booking_request/cancellation/'.$data_array_approved[$sno][1].'/est_ar')
												   ->open();
...
?>
						<tr>
							<td><a href="<?php echo site_url("sah_booking/booking_request/details/".$data_array_new_apps[$sno][1]."/".$auth);?>"><?php echo $data_array_new_apps[$sno][1];?></a></td>
