...
$form = $ui->form()->id('bkh_form')->multipart()->action('sah_booking/guest_details/display_booking_history')->open();
	...
	$(document).ready(function(){
		...
		$('select[name="building"]').change(function(){
			if($(this).val() == 'Select All'){
				...
				$.ajax({url : site_url("sah_booking/guest_details/room_planning/"+$(this).val()),
